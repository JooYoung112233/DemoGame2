...
(function (root) {
  ...
  var CHARS = {
    ...
    // 자해를 실제로 받되 그만큼 피해가 늘어나게 하면 「어디까지 태울까」가 매 턴 결정이 된다.
    fallen: { name: '타락한 감독', maxCost: 5, selfToDmg: 2.2, hpDelta: 15,
  ...
  var DIFFICULTY = {
    story:  { name: '스토리', hpMul: 1.35, atkMul: 1.05,
              note: '이야기를 보러 왔다', sub: '어느 덱이든 막을 넘긴다. 규칙을 익히는 자리다.' },
